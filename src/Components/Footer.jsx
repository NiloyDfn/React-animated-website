...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".2" className='w-full  items-start justify-normal h-screen bg-zinc-400 text-black py-20 px-20 font-["Neue_Montreal"] flex'>
        <div className="w-1/2 h-full flex flex-col justify-between  font-['Neue_Montreal'] ">
            <div className="heading">
            <h1 className='text-[8.4vw] font-semibold uppercase leading-none -mb-6'>Eye-</h1>
            <h1 className='text-[8.4vw] font-semibold uppercase leading-none '>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
            <h1 className='text-[5.6vw] font-semibold uppercase leading-none '>presentations</h1>
            <div className="dets mt-10 flex flex-col items-center justify-between gap-32">
                {["Facebook","Instagram","Twitter"].map((item,index)=> (
                  <a className='block text-2xl font-semibold ' key={index} href="#">{item}</a>
                ))}
            </div>
        </div>
    </div>
